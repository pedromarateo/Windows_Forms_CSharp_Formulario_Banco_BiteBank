        ...
        public class Unit
        {
            ...
            public Unit BuscarFicharioSQLREL(string Id)
            {
                try
                {
                    ...
                    {
                        db.Close();
                        throw new Exception("Identificador não existentente: " + Id);
                    }
                    else
                    {
                ...
                {
                    throw new Exception("Erro ao buscar o conteudo identificador: " + ex.Message);
                }
            }
            ...
            public void AlterarFicharioSQLREL()
            {
                try
                {
                    ...
                    {
                        db.Close();
                        throw new Exception("Identificador não existentente: " + this.Id);
                    }
                    else
                    {
                ...
                {
                    throw new Exception("Erro ao alterar o conteudo identificador: " + ex.Message);
                }
            }
            ...
            public void ApagarFicharioSQLREL()
            {
                ...
                {
                    throw new Exception("Erro ao excluir o conteudo identificador: " + ex.Message);
                }
            }
